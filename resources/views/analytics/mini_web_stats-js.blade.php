...
$(function () {
    ...
    var Script = function () {
        ...
        $("#active_users").sparkline([102,109,120,99,110,80,87,74,102,109,120,99,110,80,87,74], {
            type: 'bar',
            height: '100',
            barWidth: 9,
            barSpacing: 10,
        ...
        $("#bar_widget").sparkline([99,110,80,102,109,120,87,74,99,110,80,102,109,120,87,74], {
            type: 'bar',
            height: '130',
            barWidth: 12,
            barSpacing: 8,
